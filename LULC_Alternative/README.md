...
Sau khi tích hợp thêm 2 đặc trưng cao cấp `NDVI_stdDev` và `B8_contrast`, độ chính xác của mô hình đã tăng đáng kể (từ 74.31% lên **76.55%**):

* **Độ chính xác toàn cục (Overall Accuracy - OA)**: **76.55%**
* **Hệ số Kappa (Kappa Coefficient)**: **0.7069**

### Ma trận nhầm lẫn (Confusion Matrix)
```text
Thực tế \ Dự báo | Nước (0) | Đô thị (1) | Nông nghiệp (2) | Cây xanh (3) | Đất trống (4)
Nước (0)        |   209    |     1      |       8        |      9       |      26
Đô thị (1)      |     0    |   182      |      16        |     14       |      28
Nông nghiệp (2)  |    10    |    11      |     170        |     36       |       9
Cây xanh (3)    |     3    |    18      |      23        |    182       |      12
Đất trống (4)   |    23    |    21      |      15        |      0       |     181
```
