...
Tổng cộng **13 thuộc tính dự báo** được đưa vào bộ phân loại:
...
* **Lấy mẫu**: Thực thi hàm `.stratifiedSample()` trên ảnh tổng hợp Sentinel-2 năm 2021 của Hà Nội dựa trên bản đồ ESA đã phân loại lại. Thu thập mẫu phân tầng theo lớp với cấu hình tối ưu:
  * Lớp 0 (Nước): **1000 điểm**
  * Lớp 1 (Đô thị): **800 điểm**
  * Lớp 2 (Nông nghiệp): **800 điểm**
  * Lớp 3 (Cây xanh): **800 điểm**
  * Lớp 4 (Đất trống): **1200 điểm**
...
Sau khi nâng cấp cấu hình số lượng mẫu phân tầng theo từng lớp (tăng cường mẫu nước lên 1000 điểm và đất trống lên 1200 điểm):

* **Độ chính xác toàn cục (Overall Accuracy - OA)**: **77.70%** (tăng thêm 1.15% so với mức 76.55%)
* **Hệ số Kappa (Kappa Coefficient)**: **0.7183** (tăng thêm 0.0114)

### Ma trận nhầm lẫn (Confusion Matrix)
```text
Thực tế \ Dự báo | Nước (0) | Đô thị (1) | Nông nghiệp (2) | Cây xanh (3) | Đất trống (4)
Nước (0)        |   262    |     1      |      11        |      5       |      52
Đô thị (1)      |     0    |   177      |      20        |     13       |      27
Nông nghiệp (2)  |     5    |     7      |     177        |     31       |       9
Cây xanh (3)    |     5    |    18      |      34        |    186       |      11
Đất trống (4)   |    25    |    23      |      19        |      2       |     306
```

*Lưu ý: Việc bổ sung các đặc trưng thời gian và kết cấu đã giảm thiểu đáng kể sự nhầm lẫn giữa nông nghiệp và cây xanh/đất trống, cũng như nâng cao rõ rệt độ chính xác nhận diện đất đô thị và bãi cát.*
